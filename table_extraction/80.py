...
def extract_fh(type="FH", year="80"):
    mappings = {
...
def extract_uni(type="Uni", year="80"):
    mappings = {
        "Vollstudium": {"keyword": "1", "threshold": 0.72},
        "Vollstudium_WS_vorgeschrieben": {"keyword": "11", "threshold": 0.72},
        "Vollstudium_WS_vorgeschrieben2": {"keyword": "11", "threshold": 0.72},
        ...
        "Teilstudium_ab": {"keyword": "7a", "threshold": 0.76},
    }
    ...
    page1 = fh.extract_page(
        ...
        f"Studiengänge_{type}s_{year}_S.{p1}_1",
    ...
    page2 = fh.extract_page(
        ...
        f"Studiengänge_{type}s_{year}_S.{p2}_1",
...
def extract_misc(type="Sonstiges", year="80"):
    mappings = {
        "vollstudium": {"keyword": "1", "threshold": 0.9},
        "vollstudium_ws_vg": {"keyword": "11", "threshold": 0.88},
        "vollstudium_ws_vg_2": {"keyword": "11", "threshold": 0.88},
        "vollstudium_ws_vg_3": {"keyword": "11", "threshold": 0.88},
        "vollstudium_ws_vg_4": {"keyword": "11", "threshold": 0.88},
        "vollstudium_ws_empf": {"keyword": "12", "threshold": 0.9},
        "vollstudium_ws_empf_2": {"keyword": "12", "threshold": 0.9},
