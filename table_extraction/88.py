...
def extract_fh(year="88", type="FH"):
    mappings = {
...
def extract_uni(year="88", type="Uni"):
    mappings = {
        "Vollstudium": {"keyword": "1", "threshold": 0},
        "Vollstudium_WS_vorgeschrieben": {"keyword": "11", "threshold": 0},
        "Vollstudium_WS_empfohlen": {"keyword": "12", "threshold": 0},
        ...
        "Bald_Keine_Studienanfaenger": {"keyword": "Xa", "threshold": 0},
    }
...
def extract_misc(type="Sonstiges", year="88"):
    mappings = {
