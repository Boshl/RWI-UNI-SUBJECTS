...
def extract_fh(type="FH", year="83"):
    mappings = {
        "Vollstudium": {"keyword": "1", "threshold": 0.72},
        "Vollstudium2": {"keyword": "1", "threshold": 0.72},
        "Vollstudium_WS_vorgeschrieben": {"keyword": "11", "threshold": 0.77},
        "Vollstudium_WS_vorgeschrieben2": {"keyword": "11", "threshold": 0.77},
        "Vollstudium_WS_vorgeschrieben3": {"keyword": "11", "threshold": 0.77},
...
def extract_misc(type="Sonstiges", year="83"):
    mappings = {
        ...
        "vollstudium_ws_vg_4": {"keyword": "11", "threshold": 0.65},
