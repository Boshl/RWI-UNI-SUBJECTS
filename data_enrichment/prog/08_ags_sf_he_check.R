...
#
# Short description: Do final check
#
...
df <- read_dta("data_final/HEI_and_subjects_1971-1996_v2.dta")
...
df$Subject_group_code[df$Subject_orig=="Schulgartenunterricht LA GS"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Heimat- und Sachunterricht LA GS"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Sachunterricht LA SoS"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Sachunterricht LA PrimarS"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Sachunterricht LA GS"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Sachunterricht LA GS/HS"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Medienwirtschaft"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Ost(Südost)europastudien/-geschichte M"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Lehramt an Sonderschulen"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Lehramt an beruflichen Schulen"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Lehramt an Grund- und Hauptschulen"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Publizistik, Journalistik, Lektorat"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Journalistik"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Journalistik M"]<-"03"
...
df$Subject_group_code[df$Subject_orig=="Journalistik D"]<-"03"
df$Subject_group[df$Subject_orig=="Journalistik D"]<-"Rechts- Wirtschafts- und Sozialwissenschaften"

#___________________________________________________________________________####
# Export                                                                    ####

write_dta(df, "data_final/HEI_and_subjects_1971-1996_v2_saved.dta")
